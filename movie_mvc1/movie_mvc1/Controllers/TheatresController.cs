...
namespace movie_mvc1.Controllers
{
    public class TheatresController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "Tid,Tname")] Theatre theatre)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Tid,Tname")] Theatre theatre)
        {
            if (ModelState.IsValid)
            {
